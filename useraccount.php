<?php
/*
 * Kode ini digunakan untuk menampilkan dashboard pengguna yang berisi informasi pengguna, formulir pengeditan,
 * daftar film favorit, dan daftar ulasan pengguna.
 */
...
// Pernyataan SQL untuk mendapatkan informasi pengguna berdasarkan ID
...
if (!$result) {
    ...
    $conn->close();
    exit;
} else { // Menampilkan hasil dalam tabel
    ?>
        ...
        <div class="row">
            <div class="col-xs-6">
                ...
                if (isset($items)) {
                    ...
                    // Menampilkan konten film favorit
                    foreach ($items_count_value as $id => $qty) {
                        // Pernyataan SQL select untuk mendapatkan informasi film berdasarkan ID
